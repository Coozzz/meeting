...
public class CustomDialog extends Dialog {
  ...
  private String mTitle; // 对话框标题，若标题为null或空字符串，不显示标题栏
  ...
  public CustomDialog(Context context) {
    ...
    mTitle = mContext.getString(R.string.hint);
    okBtnText = mContext.getString(R.string.sure);
    cancelBtnText = mContext.getString(R.string.cancel);
