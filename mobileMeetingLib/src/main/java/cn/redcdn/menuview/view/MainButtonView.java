...
//            danmakuView.hide();
    ...
    private void isBarragLayoutVisible(IMMessageBean object) {
        if (barrageLayout.getVisibility() == VISIBLE) {
    ...
    public void addDotTextView(int position) {
        CustomLog.d("MainButtonView", "addDotTextView,position:" + String.valueOf(position));
        ...
        updateDotTextView(position);
    }

    public void removeDocTextView(int position) {
        CustomLog.d("MainButtonView", "removeDocTextView,position:" + String.valueOf(position));
    ...
    public void updateDotTextView(int position) {
    ...
    public void setNetStatusView(int netStatus) {
        if (netStatus == 0) {
            ...
            netStatusBtn.setText(mContext.getString(R.string.net_state_normal));
            if (isGood) {
            ...
            netStatusBtn.setText(mContext.getString(R.string.net_state_bad_close_video));
            isGood = false;
        } else if (netStatus == 2) {
            netStatusBtn.setVisibility(View.VISIBLE);
            netStatusImage.setBackgroundResource(MResource.getIdByName(mContext,
